<x-control-modal id="modal-edit-{{$item->id}}" method="patch" :action="route('carouselElement.update', $item)" :title="__('Edit :entity #:number', ['entity' => __('carousel element'), 'number' => $item->id])" errorBag="edit_{{$item->id}}">
